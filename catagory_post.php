...
<script src="js/jquery.js"></script>	
  ...
  <body>
	...
	$all_post_query="select * from post where status='Publish' and catagory='$cat_name' ";
			...
			<div class="container templete_section">
				<div class="row">
					<div class="col-md-6 ">
						...
						$query="select * from post where status='Publish' and catagory='$cat_name' order by id desc limit $post_start_from,$num_of_post";
						$run=mysqli_query($conn,$query);
						  ...
						  <ul class="pagination">
							<?php
								for($i=1;$i<=$total_page;$i++){
									echo "<li class='".($page_id==$i?'active':'')."'><a href='catagory_post.php?page=".$i."'>$i</a></li>";
								}
							?>
						  </ul>
						</nav>
